...
saveWtEpo=100:100:1500;
inputNum                     =125;% using 125 cells' FR
hiddenNum                    =40;% with wtConstr=1/40 doesn't work
outputNum                    =5;
wtConstr                     =1;% constraint weight reduce update step
...
%  for i=1001:1500
    ...
    if ismember(i,saveWtEpo)
        CV1E.midWt(i/100).Wt1=EW1;
        CV1E.midWt(i/100).Wt2=EW2;
    end
...
save('OFREb_cv1.mat','CV1E')

%%
close all
plot(mean(CV1E.logL(:,1:1000),1))
